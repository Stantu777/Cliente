...
import { Container, Header, Button, Card, Image, Icon, List, Segment, Label } from 'semantic-ui-react'
import { SIDEBAR_LINKS } from '../Dashboard'
import Main from '../Main'

export default class TrackThesisProposal extends PureComponent {
    constructor(props) {
        super(props)
    }
